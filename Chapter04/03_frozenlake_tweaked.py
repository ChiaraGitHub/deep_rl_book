...
HIDDEN_SIZE = 128
# Need more episodes than for cart pole, so that even if we filter we get enough
BATCH_SIZE = 100 
PERCENTILE = 30
# We need a discount factor to get higher reward for short episodes and a more
...
if __name__ == "__main__":
    ...
    # This needs to be modified to keep also past successful episodes
    full_batch = []
